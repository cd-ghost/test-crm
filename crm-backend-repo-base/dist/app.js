...
const collectionColumns = {
    leads: ['id', 'first_name', 'last_name', 'company', 'email', 'phone', 'source', 'notes', 'tenant_id', 'owner_id', 'created_at'],
    ...
    deals: ['id', 'name', 'company', 'value', 'stage', 'owner', 'close_date', 'tenant_id', 'owner_id', 'created_at'],
